#!/usr/bin/env python3
"""
Script para agregar motocicletas Haojue con especificaciones técnicas reales
"""
import os
import sys
import django
...
def add_haojue_motorcycles():
    print('=== AGREGANDO MOTOCICLETAS HAOJUE ===')
    ...
    print(f'📊 Total productos Haojue: {added_count + updated_count}')
