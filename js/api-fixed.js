...
const API = {
    ...
    financing: {
        ...
        // Simular financiamiento (CORREGIDO - endpoint correcto)
        async simulateFinancing(simulationData) {
            try {
                const response = await fetch(`${API_BASE_URL}/financing/calculator/calculate/`, {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
        ...
        // Crear solicitud de financiamiento (NUEVO)
        async createRequest(requestData) {
            return await API.users.authFetch(`${API_BASE_URL}/financing/requests/`, {
                method: 'POST',
                body: JSON.stringify(requestData)
            });
        },
        
        // Obtener solicitud específica (NUEVO)
        async getRequest(requestId) {
            return await API.users.authFetch(`${API_BASE_URL}/financing/requests/${requestId}/`);
        },
        
        // Actualizar solicitud (NUEVO)
        ...
        // Enviar solicitud para revisión (NUEVO)
        async submitRequest(requestId) {
            return await API.users.authFetch(`${API_BASE_URL}/financing/requests/${requestId}/submit/`, {
                method: 'POST'
            });
        },
        
        // Obtener configuración de calculadora (NUEVO)
        async getCalculatorConfig() {
            try {
                const response = await fetch(`${API_BASE_URL}/financing/calculator/config/`);
                const data = await response.json();
