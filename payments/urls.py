...
urlpatterns = [
    ...
    # Webhooks R4 Conecta (según documentación oficial)
    path('webhooks/r4/notify/', r4_webhooks.r4_notification_webhook, name='r4_notify_webhook'),
    path('webhooks/r4/validate-client/', r4_webhooks.r4_client_validation_webhook, name='r4_validate_client_webhook'),
]
