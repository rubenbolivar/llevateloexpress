        ...
        try:
            ...
            product, created = Product.objects.update_or_create(
                ...
                defaults={
                    ...
                    'specs_general': prod_data['specs_general'],
                    'specs_engine': prod_data['specs_engine'],
                    'specs_comfort': prod_data['specs_comfort'],
                    'specs_safety': prod_data['specs_safety'],
...
def main():
    """Función principal"""
    print("=== Importación de Datos del Frontend ===")
