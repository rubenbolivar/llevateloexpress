...
ssh $SERVER_USER@$SERVER_IP << EOF
    ...
    find $SERVER_PATH/templates -type f -name "*.html" | wc -l
...
echo -e "${GREEN}curl -I https://llevateloexpress.com/templates/politicas-privacidad.html${NC}"
